...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-electric-blue text-sm font-medium leading-5 text-deep-navy focus:outline-none focus:border-blue-700 transition duration-150 ease-in-out'
