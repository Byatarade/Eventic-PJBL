<header class="w-full flex justify-center z-50 fixed top-6 left-0 right-0 px-4 md:px-8 transition-all duration-300">
    <div class="flex items-center justify-between w-full max-w-6xl bg-white/70 backdrop-blur-xl border border-white/60 rounded-full p-2 shadow-[0_8px_30px_rgb(0,0,0,0.06)]">
        ...
        <nav class="hidden lg:flex items-center justify-center p-1.5 bg-gray-50/80 rounded-full border border-gray-200/50">
            <a href="#" class="px-6 py-2 rounded-full text-sm font-semibold text-gray-900 bg-white shadow-sm ring-1 ring-gray-900/5 transition">Beranda</a>
            <a href="#about" class="px-6 py-2 rounded-full text-sm font-semibold text-gray-500 hover:text-gray-900 hover:bg-gray-200/50 transition">About</a>
            <a href="#" class="px-6 py-2 rounded-full text-sm font-semibold text-gray-500 hover:text-gray-900 hover:bg-gray-200/50 transition">Event</a>
            <a href="#" class="px-6 py-2 rounded-full text-sm font-semibold text-gray-500 hover:text-gray-900 hover:bg-gray-200/50 transition whitespace-nowrap">Hubungi Kami</a>
        </nav>
