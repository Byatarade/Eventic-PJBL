            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                    ...
                    <div class="relative z-10">
                        ...
                        <h4 class="text-3xl font-bold text-gray-900">-</h4>
                    </div>
                </div>
            </div>
                ...
                <div class="lg:col-span-2 flex flex-col">
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex-1 flex flex-col">
                        <div class="px-6 py-5 border-b border-gray-50 flex justify-between items-center bg-gray-50/50">
                            ...
                            <a href="#" class="text-sm text-blue-600 hover:text-blue-700 font-medium hover:underline decoration-blue-200 underline-offset-4 transition-all">Jelajahi Acara</a>
                        </div>
                        ...
                        <div class="p-8 flex-1 flex flex-col justify-center items-center text-center">
                            <div class="w-24 h-24 bg-gray-50 rounded-full flex items-center justify-center mb-5 relative">
                                <div class="absolute inset-0 border-2 border-dashed border-gray-200 rounded-full animate-spin-slow"></div>
                            ...
                            <p class="text-gray-500 max-w-sm mx-auto mb-6 text-sm">Anda belum memiliki tiket untuk acara yang akan datang. Yuk temukan acara menarik di sekitarmu dan pesan tiketnya sekarang!</p>
                ...
                <div class="flex flex-col">
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex-1 flex flex-col">
                        ...
                        <div class="p-8 flex-1 flex flex-col justify-center items-center text-center">
                            ...
                            <h4 class="text-gray-900 font-bold mb-2">Belum ada aktivitas</h4>
                            <p class="text-sm text-gray-500 max-w-xs mx-auto">Riwayat transaksi pembelian tiket Anda akan muncul di sini.</p>
                        </div>
                    </div>
                </div>
            </div>
