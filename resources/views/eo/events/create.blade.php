                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="input-group group">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="organizer_social" name="organizer_social" class="premium-input-with-icon" value="{{ old('organizer_social') }}" placeholder="Contoh: @username_instagram">
                                </div>
                            </div>
                        </div>
                    </div>
