                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="input-group">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="name" name="name" class="premium-input-with-icon" value="{{ old('name') }}" required placeholder="Contoh: Konser Musik Jazz 2026" autofocus>
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div class="input-group group">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="datetime-local" id="datetime" name="datetime" class="premium-input-with-icon" value="{{ old('datetime') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="input-group group">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="location" name="location" class="premium-input-with-icon" value="{{ old('location') }}" required placeholder="Contoh: Stadion Utama GBK, Jakarta">
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="input-group group">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="organizer_name" name="organizer_name" class="premium-input-with-icon" value="{{ old('organizer_name', auth()->user()->name) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="input-group group">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="organizer_ig" name="organizer_ig" class="premium-input-with-icon" value="{{ old('organizer_ig') }}" placeholder="Contoh: @username_instagram">
                                </div>
                            </div>
                            ...
                            <div class="input-group group">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="organizer_tiktok" name="organizer_tiktok" class="premium-input-with-icon" value="{{ old('organizer_tiktok') }}" placeholder="Contoh: @username_tiktok">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                    ...
                    <div class="p-6 md:p-8" x-data="{ 
                        ...
                        <div class="bg-amber-50 border border-amber-100 p-5 mb-8 rounded-2xl flex flex-col sm:flex-row gap-4">
                            ...
                            <div>
                                <h4 class="text-amber-800 font-bold text-sm">Kebijakan Pembelian</h4>
                                <p class="text-xs text-amber-700 mt-1 leading-relaxed">
                                    Setiap jenis tiket yang ditambahkan akan memiliki kuota tersendiri. Pastikan total kapasitas sesuai dengan lokasi acara.
                                </p>
                            </div>
                        </div>
