                                ...
                                @forelse ($events as $event)
                                    <tr class="hover:bg-gray-50/50 transition-colors">
                                        ...
                                        <td class="p-4 text-right space-x-2">
                                            <button class="text-gray-400 hover:text-electric-blue transition-colors group relative" title="Lihat Event">
                                            ...
                                            <button class="text-gray-400 hover:text-yellow-500 transition-colors group relative" title="Edit Event">
                                            ...
                                            <button class="text-gray-400 hover:text-red-500 transition-colors group relative" title="Hapus Event">
