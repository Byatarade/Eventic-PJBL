<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            {{-- ============================================= --}}
            <div x-data="{ filter: 'semua', activeTicket: null }" class="space-y-6">
                {{-- Filter Buttons --}}
                <div class="flex flex-wrap gap-3">
                    <button @click="filter = 'semua'" :class="filter === 'semua' ? 'bg-[#4F46E5] text-white shadow-md shadow-indigo-200 border-transparent' : 'bg-white text-gray-600 border-gray-200 hover:bg-gray-50 hover:text-deep-navy'" class="px-5 py-2.5 rounded-full text-sm font-semibold border transition-all duration-200">Semua Tiket</button>
                    <button @click="filter = 'paid'" :class="filter === 'paid' ? 'bg-[#4F46E5] text-white shadow-md shadow-indigo-200 border-transparent' : 'bg-white text-gray-600 border-gray-200 hover:bg-gray-50 hover:text-deep-navy'" class="px-5 py-2.5 rounded-full text-sm font-semibold border transition-all duration-200">Lunas</button>
                    <button @click="filter = 'pending'" :class="filter === 'pending' ? 'bg-[#4F46E5] text-white shadow-md shadow-indigo-200 border-transparent' : 'bg-white text-gray-600 border-gray-200 hover:bg-gray-50 hover:text-deep-navy'" class="px-5 py-2.5 rounded-full text-sm font-semibold border transition-all duration-200">Pending</button>
                    <button @click="filter = 'canceled'" :class="filter === 'canceled' ? 'bg-[#4F46E5] text-white shadow-md shadow-indigo-200 border-transparent' : 'bg-white text-gray-600 border-gray-200 hover:bg-gray-50 hover:text-deep-navy'" class="px-5 py-2.5 rounded-full text-sm font-semibold border transition-all duration-200">Dibatalkan</button>
                </div>
                            ...
                            <div x-show="filter === 'semua' || filter === '{{ $t->order->status }}'"
                                ...
                                <div class="p-5">
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <a href="{{ route('user.tickets.show', $t->order) }}" class="bg-[#4F46E5] hover:bg-[#4338CA] text-white font-bold text-xs px-4 py-2.5 rounded-xl transition-all shadow-sm hover:shadow-md hover:scale-105 active:scale-95 flex items-center gap-1.5">
